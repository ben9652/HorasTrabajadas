...
void Actividad::actualizarHorasMinutosSegundos()
{
...
Actividad::Actividad(int idActividad, const char* nombre)
{
...
Actividad::Actividad(int idActividad, const char* nombre, unsigned int segundosTotales)
{
	this->idActividad = idActividad;
	this->nombre = (char*)malloc(101);
	strcpy_s(this->nombre, 101, nombre);
...
Actividad::Actividad(int idActividad, const char* nombre, unsigned int segundosTotales, size_t registrosTotales)
{
	this->idActividad = idActividad;
	this->nombre = (char*)malloc(101);
	strcpy_s(this->nombre, 101, nombre);
...
Actividad::Actividad(const Actividad& other)
{
...
Actividad::Actividad(Actividad&& other) noexcept
{
	this->idActividad = other.idActividad;
	this->nombre = (char*)malloc(101);
	strcpy_s(this->nombre, 101, other.nombre);
...
Actividad& Actividad::operator=(const Actividad& other)
{
	this->idActividad = other.idActividad;
	this->nombre = (char*)malloc(101);
	strcpy_s(this->nombre, 101, other.nombre);
...
bool Actividad::esActividadNula()
{
	return nullFlag;
}
...
unsigned int Actividad::getSegundosTotales() const
{
	return segundosTotales;
}

const std::vector<ConjuntoRegistros>& Actividad::getConjuntosRegistros()
{
	return conjuntos_registros_filtrados;
}

const std::vector<TextTable>& Actividad::getTablasConjuntos()
{
	return *tablasConjuntos;
}

void Actividad::actualizarTablas()
{
...
size_t Actividad::getRegistrosTotales() const
{
	return registrosTotales;
}

void Actividad::incrementarRegistrosTotales()
{
	registrosTotales++;
}

void Actividad::decrementarRegistrosTotales()
{
	registrosTotales--;
}

void Actividad::reiniciarRegistrosTotales()
{
	registrosTotales = 0;
}
...
void Actividad::setSegundosTotales(unsigned int segundosTotales)
{
	this->segundosTotales = segundosTotales;
...
const char* Actividad::getTiempoConsumido()
{
...
void Actividad::RegistroModificaTiempo(unsigned int tiempoViejo, unsigned int tiempoNuevo)
{
...
int Actividad::getHoras()
{
	return horas;
}

int Actividad::getMinutos()
{
	return minutos;
}

int Actividad::getSegundos()
{
	return segundos;
}

void Actividad::agregarConjuntoRegistros(const ConjuntoRegistros& cr)
{
	this->conjuntos_registros_filtrados.push_back(cr);
}

void Actividad::limpiarColeccionConjuntos()
{
	this->conjuntos_registros_filtrados.clear();
}

void Actividad::agruparRegistros(int tiempoFiltro)
{
